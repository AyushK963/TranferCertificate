/*
  ...
  - You are about to drop the column `reason` on the `TransferCertificate` table. All the data in the column will be lost.
  - You are about to drop the column `tcIssued` on the `TransferCertificate` table. All the data in the column will be lost.
