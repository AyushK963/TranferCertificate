/*
  ...
  - You are about to drop the column `rollNumber` on the `AdmissionHistory` table. All the data in the column will be lost.
  - Added the required column `classRollNumber` to the `AdmissionHistory` table without a default value. This is not possible if the table is not empty.
