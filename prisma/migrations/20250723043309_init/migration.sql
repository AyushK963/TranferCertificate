/*
  ...
  - Added the required column `reasonForLeaving` to the `TransferCertificate` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_TransferCertificate" ("caste", "character", "class", "conduct", "dateOfAdmission", "dateOfBirth", "dateOfLeaving", "fatherName", "gender", "id", "issueDate", "lastClassAttended", "motherName", "religion", "remarks", "rollNumber", "schoolLeavingFrom", "schoolLeavingTo", "section", "studentName", "tcId", "tcIssued") SELECT "caste", "character", "class", "conduct", "dateOfAdmission", "dateOfBirth", "dateOfLeaving", "fatherName", "gender", "id", "issueDate", "lastClassAttended", "motherName", "religion", "remarks", "rollNumber", "schoolLeavingFrom", "schoolLeavingTo", "section", "studentName", "tcId", "tcIssued" FROM "TransferCertificate";
